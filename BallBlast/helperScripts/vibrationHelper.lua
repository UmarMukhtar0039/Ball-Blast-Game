...
local timerService=require "helperScripts.timerService"
...
function vibrationHelper.vibrateWithPattern(pattern)
	...
	local function vibrateWithDelay()
		timerService.addTimer(pattern[index].delay,
			function()
