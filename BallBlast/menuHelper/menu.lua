...
local buttonMaker=require "menuHelper.button"
...
function menu.newMenu(name,x,y,masterImageGroup, baseImagePath,baseImageWidth,baseImageHeight,isOverlayNeeded)
	...
	if(isOverlayNeeded)then
		...
		overlay:setFillColor(1,1,1,0.4)
	end
...
function menu:addButtonToScrollpane(button,scrollContentBound)
	...
	local rect=display.newRect(self.imageGroup, scrollContentBound.xMin+scrollContentBound.width*0.5, scrollContentBound.yMin+scrollContentBound.height*0.5, scrollContentBound.xMax-scrollContentBound.xMin, scrollContentBound.yMax-scrollContentBound.yMin)
